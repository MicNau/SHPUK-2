...
const S = {
  ...
  // массивы значений, пустой = фильтр не задан. В 3D идёт последняя выбранная
  // высота (S.bedH), тип крепежа — отбор товара по названию (_bedFilterProducts).
  bedFilters: { h: [], mount: [] },
...
const BED_MOUNTS = [
  ...
  { id: 'plastic_angle', lbl: 'Пластиковый угол',   re: /пластик\w*\s+угол|пластиков\w*\s+уголок/i },
  { id: 'metal_angle',   lbl: 'Металлический угол', re: /металл\w*\s+угол|металлическ\w*\s+уголок/i },
];

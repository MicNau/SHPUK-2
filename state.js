...
// Часть разделов (ступени 2330, грядки 2357) на бэкенде пока БЕЗ товаров →
// фронт показывает заглушки STUB_RESULTS.
...
const SECTION_TAGS = {
  ...
  2331: 'fencing',  // ограждения террасы (тег fencing, 2026-08-15) — см. SECTION_TAG_ONLY
};
...
// 2331 (ограждения): бэкендер дал ручку как ?tags=fencing, без section_id —
// запрашиваем так же, чтобы не потерять товары, лежащие в соседних разделах.
const SECTION_TAG_ONLY = new Set([2430, 2331]);

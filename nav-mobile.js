...
const M_SECTION_HINTS = {
  ...
  fence: 'Забор рисуется отрезками: касание — начало, второе — конец. Касание по уже поставленной точке склеивает. Ближе 3 м к дому и террасе забор не ставится. «КАЛИТКА» делает проём 1 м.',

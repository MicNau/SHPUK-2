...
viewer3d-core.js?v=150    viewer3d-builders.js?v=53   viewer3d-railing.js?v=16
...
- **Полуступень** (п.7): `buildTerraceNosing` — доска 170×25 мм по свободному контуру
  ...
  (поднят на 1 мм от z-fighting). У стен дома доски нет, у лестницы контур НЕ рвётся.

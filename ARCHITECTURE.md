...
viewer3d-core.js?v=150    viewer3d-builders.js?v=51   viewer3d-railing.js?v=16
...
Модель без боковин работает по-прежнему (полотно дотягивается до граней столбов,
`_fenceSpanBetweenPosts`); при наличии боковин это дотягивание отключается.

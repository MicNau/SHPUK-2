...
```
styles-desktop.css?v=36   state.js?v=57              canvas.js?v=53
shared/house-builder.js?v=85                          ResourceManager.js?v=6
viewer3d-core.js?v=143    viewer3d-builders.js?v=35   viewer3d-railing.js?v=10
viewer3d-entourage.js?v=14                            nav-desktop.js?v=98
...
- **п.15** Фильтры грядок — мультивыбор (`S.bedFilters.h/mount` — массивы). Товар подходит, если
  совпал любой выбранный тип крепежа; в 3D идёт последняя выбранная высота борта.
...
- **п.7 (частично)** Клик по первой точке линии дорожек замыкает контур (точка ставится ровно
  в неё). Пересечения дорожек в 3D и так сходятся в одну поверхность (`_trimPathJunctions`);
  вопрос по площади в смете — ниже, в «Открытых вопросах».
...
- Cache-bust: `styles-desktop.css?v=36`, `state.js?v=57`, `canvas.js?v=53`,
  `viewer3d-core.js?v=143`, `viewer3d-builders.js?v=35`, `nav-desktop.js?v=98`.

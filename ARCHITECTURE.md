...
```
styles-desktop.css?v=35   state.js?v=55              canvas.js?v=50
shared/house-builder.js?v=85                          ResourceManager.js?v=6
viewer3d-core.js?v=141    viewer3d-builders.js?v=30   viewer3d-railing.js?v=10
viewer3d-entourage.js?v=14                            nav-desktop.js?v=96

...
**Что в проект не попадает.** Дорожки — API ждёт замкнутый контур ленты с отмеченной
стартовой стороной, а у нас хранится осевая линия с шириной; нужен построитель контура.

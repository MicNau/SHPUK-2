...
```
styles-desktop.css?v=35   state.js?v=56              canvas.js?v=51
shared/house-builder.js?v=85                          ResourceManager.js?v=6
viewer3d-core.js?v=142    viewer3d-builders.js?v=32   viewer3d-railing.js?v=10
...
- **Отступ забора 3 м** (п.10, `FENCE_MIN_CLEAR`): точка ближе 3 м к дому или к любой
  ...
  (контуры дома и террас, раздутые на 3 м).

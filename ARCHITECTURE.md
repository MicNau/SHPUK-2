...
viewer3d-core.js?v=150    viewer3d-builders.js?v=52   viewer3d-railing.js?v=16
...
- `buildTerraceNosing(parent, M, worldRects, deckTopY)` **[builders]** — **полуступень**: доска 170×25 мм по всему СВОБОДНОМУ контуру секции (union-контур блоков минус участки у стен дома, pad 0.30; у лестницы НЕ разрывается). Верх заподлицо с настилом (поднят на 1 мм — иначе z-fighting на перекрытии в 160 мм), наружу вылет 10 мм. Текстура всегда ВДОЛЬ доски, поперёк — ровно одна доска зашивки (привязка UV к наружной кромке, ребро `TERRACE_SIDE_TILE`). Угловые стыки: доски вдоль X доводятся до наружной грани соседней, доски вдоль Z — до внутренней, поэтому угловой квадрат закрыт ровно один раз; если у соседнего ребра доски нет (стена дома), стык не подрезается.

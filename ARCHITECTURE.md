...
Столбы модели разбирает `_fenceProtoPosts`: столбом считается меш, узкий вдоль пролёта и
высокий (или прямо названный столбом, `FENCE_POST_RE`), не опознанный как полотно или боковина.

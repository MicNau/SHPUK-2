...
- **Водосток опущен на 40 см целиком** (`DOWNPIPE_DROP` в `buildDecorFromFeatures`): длина трубы прежняя (фундамент→карниз), сдвигается только положение — выпуск колена уходит ближе к отмостке.
